...
DROP TABLE IF EXISTS competitive_troop; 
...
CREATE TABLE competitive_troop
(
...
(
    troop_id INTEGER NOT NULL REFERENCES competitive_troop(troop_id),
...
INSERT INTO competitive_troop (troop_id, foundation_date, category, bonus) VALUES
